...
from latentplan.models.lfqvae_wt_tf import TransformerPrior
import wandb
...
model_config = utils.Config(
    ...
    K=int(representation.model.K), block_size=block_size,
    ## architecture
...
wandb.init(project="latentPlanning", config=args, tags=[args.exp_name, args.tag, "prior", args.dataset,])
