...
from latentplan.models.lfqvae_wt_tf import VQContinuousVAE
import wandb
...
wandb.init(project="latentPlanning", config=args, tags=[args.exp_name, args.tag, args.dataset, 'pretrain'])
