...
from pretrain.data.dataset.vq_bet_dataset import get_relay_kitchen_train_val, TrajectorySlicerDataset


class KitchenDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.data_train, self.data_val = get_relay_kitchen_train_val(
